            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="kode_barang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_barang" placeholder="Contoh: ELK-0001, MKN-0001">
                  <small style="margin-left: 12px; color: #666;">Format: KATEGORI-XXXX (ELK=Elektronik, MKN=Makanan, ATK=Alat Tulis, dll)</small>
                </div>
                <div class="form-group" style="display:inline-block;">
