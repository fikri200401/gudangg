      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('admin/tabel_barang_deleted')?>"><i class="fa fa-trash-o"></i> Tabel Barang Dihapus</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('invoice/barangKeluarManual')?>" style="margin-bottom:10px;" type="button" class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> Invoice Manual</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->satuan?></td>
                    <td><?=$dd->jumlah?></td>
                    <td><a type="button" class="btn btn-info"  href="<?=base_url('admin/update_barangkeluar/'.$dd->id)?>" name="btn_update"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                    <td><a type="button" class="btn btn-warning btn-undo"  href="<?=base_url('admin/undo_barangkeluar/'.$dd->id)?>" name="btn_undo"><i class="fa fa-undo" aria-hidden="true"></i></a></td>
                    <td><a type="button" class="btn btn-danger btn-report"  href="<?=base_url('invoice/barangKeluar/'.$dd->id_transaksi.'/'.$dd->tanggal_keluar)?>" name="btn_report"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
              <?php }else { ?>
...
jQuery(document).ready(function($){
      ...
      $('.btn-undo').on('click',function(){
          var getLink = $(this).attr('href');
          swal({
                  title: 'Undo Barang Keluar',
                  text: 'Yakin Ingin Membatalkan Barang Keluar Ini? Stok akan dikembalikan ke Barang Masuk',
                  html: true,
