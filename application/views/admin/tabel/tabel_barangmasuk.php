        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('admin/tabel_barang_deleted')?>" style="margin-bottom:10px;" type="button" class="btn btn-warning" name="tabel_deleted"><i class="fa fa-trash" aria-hidden="true"></i> Barang Dihapus</a>
              
              <div class="alert alert-info">
                <strong>Info Kode Barang:</strong> Format kode barang: KATEGORI-XXXX (contoh: ELK-0001 untuk Elektronik, MKN-0001 untuk Makanan, dll)
              </div>
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    <?php 
                      ...
                      $this->db->where('kode_barang', $dd->kode_barang);
                      $this->db->where('deleted_at IS NULL');
                      $query_keluar = $this->db->get('tb_barang_keluar');
                      $result_keluar = $query_keluar->row();
                      $jumlah_keluar = $result_keluar->jumlah ? $result_keluar->jumlah : 0;
                      $stok_tersedia = $dd->jumlah;
                    ?>
                    <td><?=$no?></td>
                    ...
                    <td><?=$dd->satuan?></td>
                    <td><?=$dd->jumlah?></td>
                    <td><span class="label label-warning"><?=$jumlah_keluar?></span></td>
                    <td><span class="label label-<?=($stok_tersedia > 10 ? 'success' : ($stok_tersedia > 0 ? 'warning' : 'danger'))?>"><?=$stok_tersedia?></span></td>
